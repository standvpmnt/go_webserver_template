...
import (
	...
	_ "github.com/lib/pq"
	"standvpmnt.github.com/internal/data"
	"standvpmnt.github.com/internal/jsonlog"
	"standvpmnt.github.com/internal/vcs"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("DATABASE_URL"),
        "PostgreSQL DSN")
